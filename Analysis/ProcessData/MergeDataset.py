# Merge all datasets together for training the analytic model
# note: due to time restraints, this is is not yet complete. What we have is an example of how files would be read and
# combined together. Ideally we won't need to input file names manually, but rather have them generated by looping
# through the year and months (following the file naming convention)
# created by abby sun
# date: 2020-10-04
